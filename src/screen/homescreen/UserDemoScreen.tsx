...
const UserDemoScreen = ({ navigation }: RootScreenProps<'UserDemoScreen'>) => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>RTK users demo</Text>
      <Text style={styles.copy}>This screen is ready for the Redux Toolkit users query.</Text>
